...
uint8_t qma6100p_register_read(uint8_t reg, uint8_t *data, uint8_t len);    /* 连续读取qma6100p寄存器的数据 */
uint8_t qma6100p_register_write_byte(uint8_t reg, uint8_t data);            /* 向qma6100p寄存器写数据 */
void qma6100p_read_rawdata(qma6100p_rawdata_t *rawdata);                    /* 读取三轴数据(原始数据、加速度、俯仰角和翻滚角) */
